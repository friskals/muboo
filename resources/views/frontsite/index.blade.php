        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="" class="card-text" data-toggle="modal" data-target="#bookReviews" data-book-id="{{$book->id}}" 
                        style="color: #000000;text-decoration: none;"> 
                    {{$book->excerpts}}
                    </a>
                </div>
          
                <div class="modal fade" id="bookReviews" tabindex="-1" role="dialog" aria-labelledby="bookReviewsLabel" aria-hidden="true">
